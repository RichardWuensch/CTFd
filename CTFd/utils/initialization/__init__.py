...
def init_logs(app):
    ...
    logs = {
        ...
        "playgrounds": os.path.join(log_dir, "playgrounds.log"),
    }
    ...
    try:
        ...
        playgrounds_log = logging.handlers.RotatingFileHandler(
            logs["playgrounds"], maxBytes=10485760, backupCount=5
        )
        ...
        logger_playgrounds.addHandler(playgrounds_log)
    except IOError:
        pass
